...
# the first dense layers we use RNN(GRU) with 32-bit and dropout rate=1 and recurrent_dropout=0.5
...
# the first dense layers we use RNN(GRU) with 64-bit and dropout rate=0.1
