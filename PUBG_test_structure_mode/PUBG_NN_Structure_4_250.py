...
NN_model.add(Dense(77, activation='relu'))
NN_model.add(Dense(38, activation='relu'))
# output Layer
...
print("The average of model_4_250 validation_accuracy:",averagenum(val_acc))


plt.plot(epochs,
         acc,
         'red',
         label="model_4_250_acc")

plt.plot(epochs,
         val_acc,
         'b',
         label="model_4_250_val_acc")

plt.title('Model_4_250_acc')
