...
NN_model.add(Dense(37, activation='relu'))
...
print("The average of model_4_150 validation_accuracy:",averagenum(val_acc))


plt.plot(epochs,
         acc,
         'red',
         label="model_4_150_acc")

plt.plot(epochs,
         val_acc,
         'b',
         label="model_4_150_val_acc")

plt.title('Model_4_150_acc')
