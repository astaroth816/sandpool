...
NN_model.add(Dense(36, activation='relu'))
# output Layer
...
print("The average of model_3_150 validation_accuracy:",averagenum(val_acc))


plt.plot(epochs,
         acc,
         'red',
         label="model_3_150_acc")

plt.plot(epochs,
         val_acc,
         'b',
         label="model_3_150_val_acc")

plt.title('Model_3_150_acc')
