...
#We need to trans the n-dimension data to 1-D,so the first input layers we use the'Flatten' layers,

model.add(layers.Flatten(input_shape=(lookback // step,float_data.shape[-1])))

# the first dense layers we use 32-bits
